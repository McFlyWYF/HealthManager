...
import com.eric.cookbook.BuildConfig;
import com.eric.cookbook.R;
import com.eric.cookbook.utils.Constant;
import com.eric.cookbook.utils.MiscUtil;
...
public class WaveProgress extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mCircleColor = typedArray.getColor(R.styleable.WaveProgress_circleColor, getResources().getColor(android.R.color.holo_blue_light));
