...
public class FindResultModel implements FindResultContract.IFindResultModel {
    @Override
    public void getMenuResult(Map<String, String> params, final OkHttpCallback<MenuListBean.ResultBean> callback) {
        Networks.getCookApi()
                .getMenuListByContent(Networks.getCacheControl(), params)
