...
public class SearchHistoryAdapter extends BaseAdapter {
    ...
    private ArrayList<SearchHistoryBean> mHistories;
    ...
    public SearchHistoryAdapter(Context context, ArrayList<SearchHistoryBean> histories) {
        mContext = context;
        mHistories = histories;
    }

    public void refreshData(ArrayList<SearchHistoryBean> histories) {
        mHistories.clear();
        mHistories = histories;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(mContext).inflate(R.layout.item_find_history, null);
