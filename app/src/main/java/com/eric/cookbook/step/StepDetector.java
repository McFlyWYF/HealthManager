...
public class StepDetector implements SensorEventListener{
    ...
    * 检测步子，并开始计步
    * 1.传入sersor中的数据
    * huluobu.如果检测到了波峰，并且符合时间差以及阈值的条件，则判定为1步
    ...
    * */
        ...
        if (gravityOld == 0) {
            ...
            if (detectorPeak(values, gravityOld)) {
                ...
                if (timeOfNow - timeOfLastPeak >= TimeInterval
                     ...
                     * 1.连续记录10才开始计步
                     * huluobu.例如记录的9步用户停住超过3秒，则前面的记录失效，下次从头开始
     ...
     * huluobu.之前的点为上升的趋势：lastStatus为true
     * 3.到波峰为止，持续上升大于等于2次
     * 4.波峰值大于20
     * 记录波谷值
     * 1.观察波形图，可以发现在出现步子的地方，波谷的下一个就是波峰，有比较明显的特征以及差值
     * huluobu.所以要记录每次的波谷值，为了和下次的波峰做对比
     * */
